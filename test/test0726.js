...
var countOfAtoms = function (formula) {
  ...
  while (i < n) {
    ...
    if (ch === "(") {
      ...
      i++;
      const num = parseNum(formula, i, n); // 括号右侧数字
      ...
      const atom = parseAtom(formula, i, n);
      const num = parseNum(formula, i, n);
      const topMap = stack[0];
